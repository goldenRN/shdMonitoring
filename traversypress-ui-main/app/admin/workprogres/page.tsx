...
import WorkprogresTable from '@/components/workprogres/workprogresTable';
import workprogresPagination from '@/components/workprogres/workprogresPagination';
import Link from 'next/link';
import { Plus } from 'lucide-react';

const WorkprogresPage = () => {
    return (
        <>
        ...
        <div className="flex justify-between items-center px-4 py-2 bg-white  sticky top-0 z-10">
          ...
          <Link href="/admin/workprogres/new">
...
export default WorkprogresPage;
